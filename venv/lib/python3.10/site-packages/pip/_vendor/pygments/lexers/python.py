    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'slice_and_copy', 'sorted', 'staticmethod', 'str', 'sum', 'super', 'tuple',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'reload', 'repr', 'reversed', 'round', 'set', 'setattr', 'slice_and_copy',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'round', 'set', 'setattr', 'slice_and_copy', 'sorted', 'staticmethod',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'property', 'range', 'set', 'set\'', 'slice_and_copy', 'staticmethod', 'str',
...
class NumPyLexer(PythonLexer):
    ...
    EXTRA_KEYWORDS = {
        ...
        'size', 'slice_and_copy', 'solve', 'sometrue', 'sort', 'sort_complex', 'source',
